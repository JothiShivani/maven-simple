    ...
    stages {
        ...
        stage('Run SonarCloud') {
            steps {
                ...
                bat 'C:\windows\System32\config\systemprofile\AppData\Local\Jenkins\.jenkins\tools\hudson.plugins.sonar.SonarRunnerInstallation\SonarQube_Scanner\bin\sonar-scanner -Dsonar.projectKey=JothiShivani_maven-simple -Dsonar.organization=jothishivani -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=4151a4ab60add91278cab823577ffd2f13f14fac'
