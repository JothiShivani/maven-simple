    ...
    stages {
        ...
        stage('Run SonarCloud') {
            steps {
                ...
                bat "C:\windows\System32\config\systemprofile\AppData\Local\Jenkins\.jenkins\tools\hudson.plugins.sonar.SonarRunnerInstallation\SonarQube_Scanner\bin\sonar-scanner"
                }
            }
        }
